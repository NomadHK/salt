...
The host name is compiled into the kernel as "Geronimo". If you want to change it, edit line 858 in the script. Change the timezone at line 345. You can check the timezone directory names in the LiveCD's /usr/share/zoneinfo.
